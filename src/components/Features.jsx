...
const BentoCard = ({
  ...
  title,
  description,
  titleGradient = "from-blue-500 to-purple-500", // Default gradient
}) => {
  return (
    <div className="relative size-full">
      ...
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-blue-50">
        <div>
          <h1
            className={`bento-title special-font bg-clip-text text-transparent bg-gradient-to-r ${titleGradient}`}
          >
            {title}
          </h1>
          {description && (
