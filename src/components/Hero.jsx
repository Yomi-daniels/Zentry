    ...
    <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded- lg bg-blue-75 ">
        ...
        <video />
          <div className="mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
              <div onClick={handleMiniVdclick} className="origin- scale-50 opacity-0 transition-all duration-500 ease-in hover:scale-100 hover:opacity-100 ">
              <video
                ref={nextVideoRef}
        ...
        <h1 className="special-font hero-heading absolute bottom-5 right-5 z-40 text-blue-75 max-sm:font-[2rem]  ">
          G<b>a</b>ming
        </h1>
